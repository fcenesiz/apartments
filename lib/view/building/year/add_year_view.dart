import 'package:apartments/controller/building/year/add_year_view_controller.dart';
...
class AddYearView extends StatelessWidget {
  final AddYearViewController _controller = Get.put(AddYearViewController());
